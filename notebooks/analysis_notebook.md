...
<b>6.</b> What is the Average Revenue per User, regardless of Churn, for each combination of region and subscription plan?
...
### Question 6: What is the Average Revenue per User (ARPU), regardless of Churn, for each combination of region and subscription plan?

The goal of this section is to find the ARPU for each region according to their subscription pricing models. Just like Q5, churned status isn't factored into this question. 

The deliverables for this question will be <b>one SQL Query that aggregates on region and subscription plan, showing the ARPU for each combination of these categories.</b>

Purpose of Analysis:
- Determine ARPU of each region and subscription plan to give the marketing team their expected value per new subscriber given their segment
